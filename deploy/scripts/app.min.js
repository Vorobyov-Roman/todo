...
var TodoItem = React.createClass({
    ...
    render: function() {
        return React.createElement("a", {
            href: "#",
            className: "list-group-item" + (isTouch ? "" : " my-todo-item")
        }, React.createElement("span", {
            className: this.props.model.status ? "my-todo-checked" : ""
        }, this.props.model.text), React.createElement(UtilButton, {
            label: "Close",
            onClick: this.onRemove
        }, "✘"), React.createElement(UtilButton, {
            label: "Close",
