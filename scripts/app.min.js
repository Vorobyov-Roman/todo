        ...
        value: function render() {
            ...
            if (this.props.model.children) {
                ...
                childrenList = React.createElement(
                    'div',
                    { className: 'collapse', ref: 'children' },
                    React.createElement(_list2['default'], { items: this.props.model.children })
                );
            }

            if (this.state.edited) {
                input = React.createElement(_input2['default'], { onSubmit: this.insert.bind(this) });
            }
...
var director = Object.defineProperties({
    _hovered: [],
    _edited: null,
...
var TodoProto = Object.defineProperties({
